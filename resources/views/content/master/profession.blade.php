...
<div class="mt-4">
    <div class="row">
        <div class="col-12" style="min-height: 100vh; overflow-x: hidden;">
            <div class="button-container">
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addProfessionModal">
                    Tambah
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-4">
                            <table id="profession" class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($professions as $index => $profession)
                                        @include('component.modal-edit-profession')
                                        ...
                                        <tr>
                                            ...
                                            <td style="white-space: normal; word-wrap: break-word;">
                                                <p class="text-xs font-weight-bold mb-0">{{ $profession->name }}</p>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start">
                                                    <div class="action-buttons">
                                                        <button type="button"
                                                            class="btn btn-primary btn-sm text-white font-weight-bold text-xs edit-profession"
                                                            data-bs-toggle="modal" data-bs-target="#editProfessionModal"
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-form-action="{{ route('master.delete-profession', $profession->id) }}">
    ...
    @include('component.modal-add-profession')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-profession').on('click', function() {
                ...
                var professionId = button.data('id');
                var formAction = "{{ route('master.update-profession', ':id') }}";
                formAction = formAction.replace(':id', professionId);
                ...
                modal.find('#num_days_' + professionId).val(button.data('num_days'));
            });

            $('#addDetailprofessionModal').on('show.bs.modal', function(event) {
                var button = $(event.relatedTarget);
                var professionName = button.data('name');
                var modal = $(this);
                modal.find('.modal-title').text(professionName);
            });
        });

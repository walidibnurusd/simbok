...
<div class="mt-4">
                            ...
                            <table id="rank" class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    @foreach ($services as $index => $service)
                                        @include('component.modal-edit-service')
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start">
                                                    <div class="action-buttons">
                                                        <button type="button"
                                                            class="btn btn-primary btn-sm text-white font-weight-bold text-xs edit-service"
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-form-action="{{ route('master.delete-service', $service->id) }}">
    ...
    @include('component.modal-add-service')

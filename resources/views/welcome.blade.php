    ...
    <body class="d-flex flex-column h-100">
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav"
                style="background-color: #3628ef;">
                <div class="container px-5">
                    <a class="navbar-brand fw-bold">
                        <img src="{{ 'assets/img/logo-company.png' }}" alt="Brand Logo" style="height:100px;">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                            <li class="nav-item"><a class="nav-link me-lg-3"
                                    href="https://pkm-tamangapa.com.simdcare.id/login">Simpus</a></li>
                            <li class="nav-item"><a class="nav-link me-lg-3"
                                    href="{{url('/login')}}">Simbok</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
                        ...
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                    <div class="text-uppercase">Dignity &middot; Space &middot;</div>
                                </div>
                                <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Dignity
                                        Space</span></h1>
                            </div>
                        </div>
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    ...
                                    <img class="profile-img" src="{{ 'assets/img/logo-company.png' }}" alt="..." />
                                    <div class="dots-1">
                                        <!-- SVG Dots-->
        ...
        <footer class="bg-white py-4 mt-auto">
            <div class="container px-5">
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="col-auto">
                        <div class="small m-0">Copyright &copy; Dignity Space</div>
                    </div>

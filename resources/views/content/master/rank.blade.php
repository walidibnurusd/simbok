...
<div class="mt-4">
    <div class="row">
        <div class="col-12" style="min-height: 100vh; overflow-x: hidden;">
            <div class="button-container">
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addRankModal">
                    Tambah
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-4">
                            <table id="rank" class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($ranks as $index => $rank)
                                        @include('component.modal-edit-rank')
                                        ...
                                        <tr>
                                            ...
                                            <td style="white-space: normal; word-wrap: break-word;">
                                                <p class="text-xs font-weight-bold mb-0">{{ $rank->name }}</p>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start">
                                                    <div class="action-buttons">
                                                        <button type="button"
                                                            class="btn btn-primary btn-sm text-white font-weight-bold text-xs edit-rank"
                                                            data-bs-toggle="modal" data-bs-target="#editRankModal"
                                                            data-id="{{ $rank->id }}"
                                                            data-name="{{ $rank->name }}">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-form-action="{{ route('master.delete-rank', $rank->id) }}">
    ...
    @include('component.modal-add-rank')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-rank').on('click', function() {
                ...
                var rankId = button.data('id');
                var formAction = "{{ route('master.update-rank', ':id') }}";
                formAction = formAction.replace(':id', rankId);
                ...
                modal.find('#num_days_' + rankId).val(button.data('num_days'));
            });

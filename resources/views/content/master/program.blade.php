...
<div class="mt-4">
    <div class="row">
        <div class="col-12" style="min-height: 100vh; overflow-x: hidden;">
            <div class="button-container">
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addProgramModal">
                    Tambah
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-4">
                            <table id="program" class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($programs as $index => $program)
                                        @include('component.modal-edit-program')
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start">
                                                    <div class="action-buttons">
                                                        <button type="button"
                                                            class="btn btn-primary btn-sm text-white font-weight-bold text-xs edit-program"
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-form-action="{{ route('master.delete-program', $program->id) }}">
    ...
    @include('component.modal-add-program')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-program').on('click', function() {
                ...
                var formAction = "{{ route('master.update-program', ':id') }}";
                formAction = formAction.replace(':id', programId);
                ...
                modal.find('#num_days_' + programId).val(button.data('num_days'));
            });

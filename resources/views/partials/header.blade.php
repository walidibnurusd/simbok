...
.dataTables_wrapper .dataTables_paginate .page-item.active .page-link {
    background-color: #1000f7 !important;
    color: white !important;
    border-color: #1000f7 !important;
}
...
.dataTables_wrapper .dataTables_paginate .page-link:hover {
    ...
    /* Mengubah teks di seluruh DataTables menjadi hitam */
.dataTables_wrapper {
    color: black !important;
}

/* Pastikan teks dalam pagination, search, dan info juga hitam */
.dataTables_info,
.dataTables_paginate,
.dataTables_length,
.dataTables_filter,
